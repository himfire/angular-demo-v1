...
export class WelcomeComponent implements OnInit {
  ...
  lessons:Lesson[] = []
  constructor(private classification:ClassificationService,private lesson:LessonsService,private route:Router) {
  ...
  ngOnInit(): void {
    ...
    this.getAllLessons();
    tippy('#getStarted', {
      content: "Join us and get started!",
      placement: 'right',
      arrow: true,
      animation: 'fade',
      animateFill: true,
  ...
  signup(role: string) {
    this.route.navigateByUrl("signup", {state : {role: role}})
  }
}
